...
void Demo8::initTextures()
{
	...
	GLuint texID;
	FIBITMAP *image = ImageManager::GenericLoader(getResFile("grassDIFFUSE.jpg"), 0);
	...
	image = ImageManager::GenericLoader(getResFile("grassNORMAL.jpg"), 0);
	GLuint textureID2;
...
#pragma region Draw Scene Entities
	...
	glm::mat4 projectionMatrix({ 1.0f, 0.f, 0.f,
								 0.f, 1.f, 0.f,
								 0.f, 0.f, 1.f });
	...
	uniform = glGetUniformLocation(ss->m_activeShader->m_programObject, "Tex1");
	glUniform1i(uniform, 0);
	//glBindTexture(GL_TEXTURE_2D, GL_TEXTURE0);
	glActiveTexture(GL_TEXTURE1);
	uniform = glGetUniformLocation(ss->m_activeShader->m_programObject, "Tex2");
